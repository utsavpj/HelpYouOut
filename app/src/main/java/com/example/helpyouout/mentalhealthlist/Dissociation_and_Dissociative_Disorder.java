...
public class Dissociation_and_Dissociative_Disorder extends AppCompatActivity {
    Button pop_close;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ml_dissociation_and__dissociative__disorder);
